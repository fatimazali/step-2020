...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAvailabilityTooShort() {
    // Have one required person and one optional person, but make it so that there is just enough room at one point in the day to
    // have the meeting. The overlap in availability between both attendees is too short, so the optional attendee will be ignored.
    //
    // Events  : |--A--|     |----A----|
    //         : |      |-B-|          |
    // Day     : |---------------------|
